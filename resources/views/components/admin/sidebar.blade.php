                ...
                <div class="px-6 pt-4">
                    <ul class="flex flex-col space-y-2">
                        ...
                        <li class="relative text-gray-200 hover:text-white focus-within:text-white">
                            ...
                            <a href="#" class="inline-block w-full py-2 pl-8 pr-4 text-sm rounded hover:bg-blue-800 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:bg-blue-800">Admin
                                Users</a>
                        </li>
                        ...
                        <li x-data="{ open:false }">
                            ...
                            <div class="pt-2 pl-4">
                                <ul class="flex flex-col pl-2 text-gray-200 border-l border-gray-300 space-y-2" x-show="open" @click.outside="open = false">
                                    <li>
                                        <a href="#" class="inline-block w-full px-4 py-2 text-sm rounded hover:bg-blue-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-blue-500 focus:text-white">Categories</a>
                                    </li>
                        ...
                        <li class="relative text-gray-200 hover:text-white focus-within:text-white">
                            ...
                            <a href="#" class="inline-block w-full py-2 pl-8 pr-4 text-sm rounded hover:bg-blue-800 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:bg-blue-800">Gallery</a>
                        </li>
                    </ul>
                </div>
