        ...
        <div x-cloak class="fixed inset-x-0 z-10" :class="isScrolled ? 'py-4 border-b border-gray-100 bg-white/80 backdrop-blur shadow-md' : 'bg-primary py-6'">
            <nav class="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
                ...
                <div class="hidden space-x-8 md:flex md:ml-10">
                    <a href="{{ route('blogs') }}" class="text-base leading-6 font-medium" :class="isScrolled ? 'text-gray-700 hover:text-gray-900' : 'text-gray-100 hover:text-white'">Blogs</a>
                    <a href="{{ route('events') }}" class="text-base leading-6 font-medium" :class="isScrolled ? 'text-gray-700 hover:text-gray-900' : 'text-gray-100 hover:text-white'">Events</a>
        ...
        <div class="rounded-xl shadow-sm bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
            ...
            <div class="pt-5 pb-6">
                <div class="px-2 text-base font-medium text-gray-700">
                    <a href="{{ route('blogs') }}" class="tracking-wide text-center block px-3 py-4 hover:text-gray-900">Blogs</a>
                    <a href="{{ route('events') }}" class="tracking-wide text-center block px-3 py-4 hover:text-gray-900">Events</a>
