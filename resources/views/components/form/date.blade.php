...
<div x-data x-init="new Pikaday({ field: $refs.datepicker, format:'YYYY-MM-DD' })" for="published_at" class="flex">
    ...
    <input x-ref="datepicker" type="text" {{ $attributes }} name="{{ $name }}" class="@error($name) border-red-600 @enderror w-full p-2 border border-gray-300 rounded-r form-input">
</div>
