<x-admin.app title="Merchandise">
    <div class="mt-8 space-y-6">
        <div class="flex justify-between ">
            <h1 class="text-xl font-bold text-gray-900 uppercase">All Merchandise</h1>

            <x-button.link link="{{ route('admin.merchandise.create') }}"> Add new Merchandise </x-button.link>
        </div>
                        ...
                        <tr class="text-gray-700 ">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm space-x-4">
                                    <a href="{{ route('admin.merchandise.edit',$merchandise->id) }}" class="flex items-center justify-between px-2 py-2 text-sm font-medium text-green-500 rounded-lg leading-5 focus:outline-none focus:shadow-outline-gray" aria-label="Edit"> <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
