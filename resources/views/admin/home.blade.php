        ...
        <div class="mt-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white shadow-sm rounded-md flex items-center justify-between p-3 text-gray-700 font-medium group">
                    <div class="flex justify-center items-center w-14 h-14 bg-primary-light/10 rounded-full transition-all duration-300 transform group-hover:rotate-12">
                        <svg class="w-8 h-8 stroke-current text-primary transform transition-transform duration-500 ease-in-out" viewBox="0 0 24 24" fill="none" >
                ...
                <div class="bg-white shadow-sm rounded-md flex items-center justify-between p-3 text-gray-700 font-medium group">
                    <div class="flex justify-center items-center w-14 h-14 bg-primary-light/10 rounded-full transition-all duration-300 transform group-hover:rotate-12">
                        <svg class="w-8 h-8 stroke-current text-primary transform transition-transform duration-500 ease-in-out" viewBox="0 0 24 24" fill="none" >
                            <path stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                        </svg>
                    </div>
                    <div class="text-right">
