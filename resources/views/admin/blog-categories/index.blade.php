                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b bg-gray-50 ">
                            ...
                            <th class="px-4 py-3">Post Count</th>
                    ...
                    <tbody class="bg-white divide-y ">
                        ...
                        <tr class="text-gray-700 ">
                            <td class="px-4 py-3">
                                <p class="font-semibold text-md">{{ $blogCategory->title }}</p>
                            </td>
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center text-sm space-x-4">
                                    <a href="{{ route('admin.blog-categories.edit',$blogCategory->id) }}" class="flex items-center justify-between px-2 py-2 text-sm font-medium text-green-500 rounded-lg leading-5 focus:outline-none focus:shadow-outline-gray" aria-label="Edit">
