        ...
        <div class="container mx-auto">
            ...
            <div class="grid gap-8 grid-rows-3 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-8">
                <div class="overflow-hidden relative card">
                    <div class="front absolute top-0 left-0 w-full h-full bg-gray-900 text-white flex items-center justify-center transform duration-300">
                      <p><img src="{{ asset('image/blog.jpg') }}" class="w-full"></p>
                    </div>
                    <div class="poppins primary text-xl font-semibold back absolute top-0 left-0 w-full h-full text-black flex items-center justify-center transform duration-300 -translate-x-full">
                      <p>Skill IT V1.0</p>
                    </div>
                  </div>
