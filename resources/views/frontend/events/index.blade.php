<x-frontend.app title="Events">
            ...
            <div class="flex flex-col overflow-hidden rounded-xl shadow-xl">
                ...
                <div class="flex flex-1 flex-col justify-between bg-white p-6">
                    <div class="flex-1">
                        ...
                        <a href="{{ route('blogs.show', $upcomingEvent->slug) }}" class="mt-2 block">
                        ...
                        <div class="flex flex-col space-y-2 mt-4">
                            <div class="flex space-x-4 ">
                                ...
                                <span class="font-medium text-greish">{{ $upcomingEvent->venue }}, {{ $upcomingEvent->venue_address }}</span>
                            </div>
    ...
    <section class="mt-10 sm:mt-24 mb-10 sm:mb-24 max-w-7xl mx-auto px-8 sm:px-6">
        ...
        <div class="flex justify-center items-center">
            <div class="w-[65%] h-48 bg-white shadow-xl rounded-2xl mb-8 md:mb-24 grid grid-cols-4">
                <div class="">
                ...
                <div class="flex flex-col h-48 bg-primary justify-center items-center font-semibold text-white text-4xl text-center rounded-r-2xl">
                    <span class="text-4xl">
                        {{ $upcomingEvent->eventDay() }}
                    </span>
                    <span class="text-2xl">
                        {{ $upcomingEvent->eventMonth() }}
                    </span>
                </div>
            </div>
        </div>
