                            ...
                            <div class="event_card mt-8 rounded-xl bg-white sm:w-auto">
                                ...
                                <div class="event_card_contens p-7 ">
                                    ...
                                    <p class="home_text py-4 text-base font-light leading-6">
                                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum id pariatur nam asperiores. Ad qui dicta earum, minima consectetur aliquid aut iste voluptatem distinctio. Delectus, repudiandae iusto? Fuga, nisi. Commodi, cumque deleniti?
                                    </p>
                                    <hr class="py-2" />
                                    {{-- <button
