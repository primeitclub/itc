<x-frontend.app title="Home">
    ...
    <!--         <a class="text-greish text-center font-medium" href="">view more</a> -->
    <!--         <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-greish"> -->
    ...
    <section class="mt-24 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="mt-10 flex space-x-6" >
            <article class="w-72 mx-auto bg-white border-b-8 border-b-primary rounded-3xl px-8 py-6 shadow-sm hover:shadow-md">
