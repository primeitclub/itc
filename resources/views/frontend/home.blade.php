<x-frontend.app title="Home">
    ...
    <section class="max-w-7xl flex flex-col-reverse md:flex-row items-center mx-auto px-4 sm:px-6">
        ...
        <div class="mt-10 md:w-1/2">
            ...
            <p class="font-dmsans mt-6 text-base sm:text-xl text-greish">
            ...
            <button class="button mt-7 py-3 px-6 leading-6 font-dmsans rounded-3xl">
                <div class="flex justify-between items-center space-x-2">
                    <a class="text-white font-medium" href="">Learn more</a>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 text-centeborder-primary bg-white rounded-full">
                ...
                <div class="flex-1 flex flex-col justify-between max-w-lg">
                    <header class="mt-8 lg:mt-0">
                        ...
                        <div class="mt-4">
                            ...
                            <span class="mt-2 block text-greish text-xl font-semibold">
                                Facilitator : Some Speaker 
                            </span>
                        </div>
                    </header>

                    <div class="text-sm mt-2 text-greish max-w-lg">
                        <p>
                    ...
                    <footer class="mt-4 flex justify-between">
                        <button class="button transition-colors duration-300 mt-7 py-3 px-8 leading-6 font-dmsans rounded-3xl">
                            <a href="#" class="text-white font-medium" >Register Now</a >
                        </button>
                        <button class="transition-colors bg-gray-300/80 hover:bg-gray-300/90 duration-300 mt-7 py-3 px-8 leading-6 font-dmsans rounded-3xl">
                            <a href="#" class="text-black font-medium" >Know More</a >
                        </button>
                    </footer>
                </div>
            </div>
            ...
            <div class="grid sm:grid-cols-2 gap-8">
                    ...
                    <div class="mx-auto mt-10">
                        ...
                        <footer class="mt-8 mb-8 flex items-center justify-between">
                            <div>
                                <a href="" class="bg-white-100 py-4 px-8 text-xs font-semibold border border-primary text-black-700 rounded-full hover:bg-primary-light hover:border-primary-light hover:text-white">Read More</a> </div>
                        </footer>
                    </div>
                </div>
        </article>
    ...
    <div class="mx-auto max-w-xs mt-10">
        <div class="flex items-center justify-center cursor-pointer">
            <a class="flex space-x-4 text-greish items-center font-medium hover:text-gray-800" href="{{ route('blogs') }}">view more
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" />
                </svg>
            </a>
    ...
    <section class="mt-24 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="swiper teamSwiper">
            <div class="swiper-wrapper mt-10 flex space-x-4" >
                ...
                <article class="swiper-slide w-72 mx-auto bg-white border-b-8 border-b-primary rounded-3xl px-8 py-6 shadow-sm hover:shadow-md">
                    <div class="mt-6 w-fit mx-auto">
                        <img src="https://api.lorem.space/image/face?w=120&h=120&hash=bart89fe" class="rounded-full w-36 h-36 border-4 border-primary outline outline-4 outline-offset-4 outline-secondary">
                    </div>
